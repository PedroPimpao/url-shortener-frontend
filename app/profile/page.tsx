...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f6fa]">
      <AppHeader />
      <main className="mx-auto max-w-[1275px] px-5 py-8 pb-[60px] md:px-10">
        <div>
          ...
          <form onSubmit={save}>
            <div className="flex flex-col items-start gap-6 lg:flex-row">
              <div className="flex flex-[1.7] flex-col gap-6">
                <Card className="px-8 py-7">
                  <h2 className="mb-5 flex items-center gap-2 text-[19px] font-bold">
                    <UserRound className="size-[17px] text-indigo-600" />
                    Profile Details
                  </h2>
                ...
                <Card className="px-8 py-7">
                  <h2 className="mb-5 flex items-center gap-2 text-[19px] font-bold">
                    <LockKeyhole className="size-[17px] text-indigo-600" />
                    Change Password
                  </h2>
                  <div className="mb-[18px]">
                    <label
              ...
              <aside className="w-full flex-1 rounded-xl border border-[#dcdff8] bg-[#e6e9fb] px-7 py-8 text-center">
                <div className="mx-auto mb-4 flex size-[72px] items-center justify-center rounded-full bg-indigo-600 text-2xl font-bold text-white">
                  {initials}
                </div>
            ...
            <div className="mt-6 flex justify-end gap-3">
              <Button
                type="reset"
                variant="outline"
                className="h-11 border-[#d8dae5] px-[22px]"
                onClick={() => {
                  setError('');
                  setMessage('');
                }}
              ...
              <Button
                disabled={saving}
                className="h-11 bg-indigo-600 px-[22px] hover:bg-indigo-700"
              >
